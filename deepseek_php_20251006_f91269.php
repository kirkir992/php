<?php
// Alternative index.php with simple delete confirmation
include 'config.php';
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<a href='delete.php?id=" . $row['id'] . "' class='btn btn-delete' onclick='return confirm(\"Are you sure you want to delete server: " . htmlspecialchars($row['server_name']) . "?\")'>Delete</a>";
                    echo "</td>";
                    echo "</tr>";
                }
            } else {
